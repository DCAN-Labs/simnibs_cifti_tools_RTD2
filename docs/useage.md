...
Ensure you have access to and know the following information:
- faird, and miran045 shares on MSI
- The subjects ID: i.e. MSC06
- The session identifier: i.e. ses-1
...
3. Edit settings_file_SUBJ.sh
 ...
 1. dlpfc
 2. all
To use the brain_target *all* you will need to also include the flag `--P_F_dlabel_table` with the path to a functional dlabel table to use as a reference.
